    ...
    <asp:ChangePassword ID="ChangeUserPassword" runat="server" CancelDestinationPageUrl="~/"
        ...
        <ChangePasswordTemplate>
            ...
            <div class="accountInfo">
                <asp:Panel runat="server" Default
                    ...
                    <p class="submitButton">
                        <asp:Button CssClass="btn btn-error" ID="CancelPushButton" runat="server" CausesValidation="False" CommandName="Cancel"
                            Text="Cancel" />
                        <asp:Button CssClass="btn btn-primary" ID="ChangePasswordPushButton" runat="server" CommandName="ChangePassword"
